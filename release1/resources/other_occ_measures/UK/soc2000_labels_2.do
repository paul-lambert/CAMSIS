...
** Defines UK SOC200 labels in a Stata label item 


** New label items are generated as follows for: 
*   soc2kl - unit groups (4-digit) 
*   soc2k3l - minor groups (3-digit)
*   soc2k2l - sub-major groups (2-digit)
*   soc2k1l - major groups (1-digit)
*   soc2kal - all combined
...
capture label drop soc2k3l;

label define soc2k3l  
 ...
 117 "Protective services officers" 
 118 "Health and social service managers" 
 ...
 354 "Sales and related assocaite professionals" 
 ...
 922 "Elementary personal service occupations" 
...
capture label drop soc2k2l;
 
label define soc2k2l  
...
capture label drop soc2k1l;
 
label define soc2k1l  
...
capture label drop soc2kal;
 
label define soc2kal  
 1 "Managers and senior officials" 
 2 "Professional occupations" 
 3 "Associate professional and technical occupations" 
 4 "Administrative and secretarial occupations" 
