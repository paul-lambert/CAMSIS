...
*ssssssoc20iss soc2000=hocc isti=hisco88
        soo=hsoo.
*ssssssoc20iss soc2000=wocc isti=wisco88
        soo=wsoo.
...
if (!soc20=1122 & !soe=2) !isti=1313. /* 1223 was title only default.

if (!soc20=1151 & !soe=2) !isti=1317. /* 1227 was title only default.

if (!soc20=1161 & !soe=2) !isti=1316. /* 1226 was title only default.
if (!soc20=1162 & !soe=2) !isti=1316. /* 1226 was title only default.
if (!soc20=1163 & !soe=2) !isti=1314. /* 1224 was title only default.

if (!soc20=1182 & !soe=1) !isti=1229. /* 1319 was title only default.
if (!soc20=1183 & !soe=1) !isti=1229. /* 1319 was title only default.
if (!soc20=1185 & !soe=1) !isti=1228. /* 1318 was title only default.

if (!soc20=1211 & !soe=1) !isti=1221. /* 1311 was title only default.
if (!soc20=1212 & !soe=1) !isti=1221. /* 1311 was title only default.
if (!soc20=1219 & !soe=1) !isti=1221. /* 1311 was title only default.

if (!soc90=1221 & !soe=1) !isti=1225. /* 1315 was title only default.
if (!soc90=1222 & !soe=2) !isti=1317. /* 1227 was title only default.
if (!soc90=1223 & !soe=1) !isti=1225. /* 1315 was title only default.
if (!soc90=1224 & !soe=1) !isti=1225. /* 1315 was title only default.
if (!soc90=1225 & !soe=1) !isti=1229. /* 1319 was title only default.
if (!soc90=1226 & !soe=1) !isti=1226. /* 1316 was title only default.

if (!soc90=1231 & !soe=1) !isti=1227. /* 1317 was title only default.
if (!soc90=1232 & !soe=1) !isti=1224. /* 1314 was title only default.
if (!soc90=1233 & !soe=1) !isti=1228. /* 1318 was title only default.
if (!soc90=1235 & !soe=1) !isti=1229. /* 1319 was title only default.
if (!soc90=1239 & !soe=1) !isti=1229. /* 1319 was title only default.


********************.
* Supplement : remove comments if want to code missing soo as missing isco. 
*if (!soc20=1121 & !soo=9) !isti=-999  . 
*if (!soc20=1122 & !soe=9) !isti=-999  .
*if (!soc20=1151 & !soe=9) !isti=-999  .
*if (!soc20=1161 & !soe=9) !isti=-999  .
*if (!soc20=1162 & !soe=9) !isti=-999  .
*if (!soc20=1163 & !soe=9) !isti=-999  .
*if (!soc20=1182 & !soe=9) !isti=-999  .
*if (!soc20=1183 & !soe=9) !isti=-999  .
*if (!soc20=1185 & !soe=9) !isti=-999  .
*if (!soc20=1211 & !soe=9) !isti=-999  .
*if (!soc20=1212 & !soe=9) !isti=-999  .
*if (!soc20=1219 & !soe=9) !isti=-999  .
*if (!soc90=1221 & !soe=9) !isti=-999  .
*if (!soc90=1222 & !soe=9) !isti=-999  .
*if (!soc90=1223 & !soe=9) !isti=-999  .
*if (!soc90=1224 & !soe=9) !isti=-999  .
*if (!soc90=1225 & !soe=9) !isti=-999  .
*if (!soc90=1226 & !soe=9) !isti=-999  .
*if (!soc90=1231 & !soe=9) !isti=-999  .
*if (!soc90=1232 & !soe=9) !isti=-999  .
*if (!soc90=1233 & !soe=9) !isti=-999  .
*if (!soc90=1235 & !soe=9) !isti=-999  .
*if (!soc90=1239 & !soe=9) !isti=-999  .
